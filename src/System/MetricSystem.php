...
enum MetricSystem implements System
{
    ...
    private const string QUECTO_MULTIPLIER = '1e-30';
    private const string RONTO_MULTIPLIER = '1e-27';
    ...
    public function factor(): BigDecimal
    {
        return BigDecimal::of(match ($this) {
            self::QUECTO => self::QUECTO_MULTIPLIER,
            self::RONTO => self::RONTO_MULTIPLIER,
            ...
            self::RONNA => self::RONNA_MULTIPLIER,
            self::QUETTA => self::QUETTA_MULTIPLIER,
        });
    }
}
